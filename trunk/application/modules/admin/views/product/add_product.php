...
<div class="widgetcontent">
    <form class="stdform" enctype="multipart/form-data" action="<?php echo site_url('admin/product_controller/insertProducts') ?>" method="post">
        <p>
            <label> Tên </label>
            <span class="field"><input type="text" name="txtname" class="input-large" placeholder="Lastname"/></span>
        </p>
        ...
        <p>
            ...
            <span class="field"><textarea id="autoResizeTA" cols="80" name="txtdes" rows="5" class="span5"
                                          style="resize: vertical"></textarea></span>
        </p>
        ...
        <p>
            <label>Chi tiết sản phẩm</label>
                            <span class="field">
                                <textarea cols="80" rows="5" id="textarea2" name="chitiet" class="span5"></textarea>
                            </span>
        </p
