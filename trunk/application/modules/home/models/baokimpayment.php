...
class BaoKimPayment extends CI_Model
{
	// URL checkout của baokim.vn
	//private $baokim_url = 'http://kiemthu.baokim.vn/payment/order/version11'; // link test
	private $baokim_url = 'https://www.baokim.vn/payment/order/version11'; // link thật
	// Mã merchante site 
	private $merchant_id = '13259';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	// Mật khẩu bảo mật
	private $secure_pass = '31754241a5abdb12'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
