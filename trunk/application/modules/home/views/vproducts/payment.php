    ...
    <div class="boxconfirm clearfix">
        <form action="" method="post" class="formpay">
            ...
            <div class="col">
                ...
                <div class="col-inside" style="margin-top: 37px;">
                    <?php
                    ...
                    <div class="payment">
                        <h5 class="total" style="font-size: 10pt;font-weight: bold;"><span style="float: left;padding: 5px;">Tổng tiền: </span><span style="float: right;padding: 5px;"><?php echo number_format($tong, 2, ',', '. '); ?> VNĐ</span></h5>
