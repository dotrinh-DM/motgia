                ...
                <div class="col-inside">
                    ...
                    <div id="_otherAddress" class="form col-box" style="display: block;">
                        ...
                        <div>
                            ...
                            <input type="text" id="phone" name="phone" value="<?php echo count($profile) ? $profile['phone'] : ''; ?>">
                        ...
                        <div class="select">
                            ...
                            <select id="province" name="province">
                                ...
                                for ($i = 0; $i < 62; $i++) {
                                    if ($arr[$i] == $profile['province'] && count($profile))
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" ><?php echo count($profile) ? $profile['address'] : ''; ?></textarea>
                            <span class="tooltip">Vui nhập số nhà và tên đường nơi bạn đang sống</span>
                        </div>
                        <div>
                            <label for="address">Ghi chú đơn hàng:</label>
                            <textarea id="address" name="note"> </textarea>
                        </div>
                    </div>
                </div>
            </div>
...
//                        echo $seller = $uid;
                    ...
                    <div class="payment">
                        ...
                        <input type="submit" class="btn" value="Tiến hành thanh toán" name="thanhtoan"/>
                    </div>
                </div><!-- End .box-drop-->
            </div>
        </form>
