    ...
    <div class="form boxcart box-drop">
            ...
            if (isset($detail) && count($detail)) {
                ...
                echo '
                        ...
                        <tr>
                            ...
                            <td>
                                <p><b>'; echo ($seller['method']==0)?'Thanh toán tại nhà': 'Thanh toán trực tuyến';echo'</b></p>
                            </td>
                        </tr>
                        ';
            }
            ...
            if (isset($seller) && count($seller)) {
                echo '
                        <tr>
                            ...
                            <td>
                                <p>' . $seller['date_cr'] . '</p>
                                <p>';echo($seller['method']==0)?'Thanh toán khi nhận hàng': 'Thanh toán trực tuyến'; echo'</p>
                            </td>
                        </tr>
        ...
        <p><b>Cảm ơn đã quý khách đã sử dụng dịch vụ trên onepricemarket.tk !</b></p>      
                ...
                echo '
                    ...
                    ';
                if ($seller['status'] == 2 && $seller['method'] == 0)
                echo '
                    <form method="post" action="">
                    <center><input type="submit" class="btn btn-primary btn-lg btn-block" style="
                            width: 300px;
